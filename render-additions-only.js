...
// Bu kodları mevcut Render backend'inize ekleyin (mevcut kodları değiştirmeyin)

// 1. VERİ YAPILARI (Dosyanın başına, mevcut veri yapılarından sonra ekleyin)
...
// 3. YENİ API ENDPOINT'LERİ (server.listen()'den önce ekleyin)
...
2. Veri yapılarını dosyanın başına ekleyin (mevcut kodları değiştirmeyin)
...
✅ OpenAI API entegrasyonu (mevcut - korundu)
*/
