...
// Sponsor bot (OpenAI entegrasyonu)
  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "Sen Hepon Sigorta'nın müşteri hizmetleri temsilcisisin. Sigorta konularında yardımcı oluyorsun. Kısa ve net cevaplar ver."
        },
        {
          role: "user",
          content: text
...
server.listen(PORT, () => {
  ...
  console.log('🤖 OpenAI API entegrasyonu hazır');
});
